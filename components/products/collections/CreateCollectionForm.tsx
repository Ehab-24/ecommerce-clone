...
import { Condition, Operator, ApiCollectionSchema, ApiCollection } from "@/types/collection";
...
export default function CreateCollectionForm() {
  ...
  const [collection, setCollection] = React.useState<ApiCollection>(defaultCollection)
  ...
  async function handleSave() {
    ...
    try {
      ...
      const { status } = await axios.post("/api/products/collections", collection)
