...
export default function AllLocationsPopover({ locations, selectedLocation, setSelectedLocation }: { locations: Location[], selectedLocation: Location | null, setSelectedLocation: React.Dispatch<React.SetStateAction<Location | null>> }) {
