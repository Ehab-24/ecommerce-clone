...
export default function RemoveProductsFromCollectionsDialog({ selectedProducts }: { selectedProducts: Product[] }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Remove {selectedProducts.length} product(s) to collecitons</DialogTitle>
        </DialogHeader>
