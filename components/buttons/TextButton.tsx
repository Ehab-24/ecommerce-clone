export default function TextButton({ children, disabled = false, onClick, className = "" }: { className?: string, disabled?: boolean, children: React.ReactNode, onClick?: React.MouseEventHandler<HTMLButtonElement> }) {
  return (
    <button
      disabled={disabled}
      onClick={onClick}
