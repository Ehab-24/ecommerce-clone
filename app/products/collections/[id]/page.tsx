...
import { Collection, Condition, Operator } from "@/types/collection"
      ...
      <div className="flex-col max-w-4xl w-full flex gap-6 p-8 ">
        ...
        <div className=" flex flex-col w-full max-w-3xl self-center gap-4 mb-8">
          <Card className="flex flex-col gap-4 items-stretch">
            <Input id="title" value={collection.title} onChange={e => setCollection({ ...collection, title: e.target.value })} label="Title" placeholder="e.g. Summer collection, Under $100, Staff picks" />
            <TextArea label="Description" value={collection.description} onChange={e => setCollection({ ...collection, description: e.target.value })} />
          </Card>
